...
<head>
    ...
    <title>@yield('title', 'Sampharindo Group - Lowongan Kerja & Karir Resmi')</title>
    ...
    <link href="{{ asset('assets/icon.ico') }}" rel="apple-touch-icon">
...
<body class="{{ \Request::is('/') ? 'index-page' : 'detail-page' }}">
